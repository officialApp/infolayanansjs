 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(function(t){t[t["UNKNOWN"]=0]="UNKNOWN",t[t["VISIBLE"]=1]="VISIBLE",t[t["HIDDEN"]=2]="HIDDEN"})(P||(P={}));var D=["firebase_","google_","ga_"],B=new RegExp("^[a-zA-Z]\\w*$"),K=40,q=100;function V(){var t=F.getInstance().navigator;return"serviceWorker"in t?t.serviceWorker.controller?2:3:1}function x(){var t=F.getInstance().document,e=t.visibilityState;switch(e){case"visible":return P.VISIBLE;case"hidden":return P.HIDDEN;default:return P.UNKNOWN}}function z(){var t=F.getInstance().navigator,e=t.connection,n=e&&e.effectiveType;switch(n){case"slow-2g":return 1;case"2g":return 2;case"3g":return 3;case"4g":return 4;default:return 0}}function $(t){if(0===t.length||t.length>K)return!1;var e=D.some((function(e){return t.startsWith(e)}));return!e&&!!t.match(B)}function J(t){return 0!==t.length&&t.length<=q}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ot,at=1;function st(){return at=2,ot=ot||ut(),ot}function ct(){return 3===at}function ut(){return ft().then((function(){return R()})).then((function(t){return Q(t)})).then((function(){return lt()}),(function(){return lt()}))}function ft(){var t=F.getInstance().document;return new Promise((function(e){if(t&&"complete"!==t.readyState){var n=function(){"complete"===t.readyState&&(t.removeEventListener("readystatechange",n),e())};t.addEventListener("readystatechange",n)}else e()}))}function lt(){at=3}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mt(t,e){pt||(pt=St(kt)),pt(t,e)}function At(t){var e=O.getInstance();!e.instrumentationEnabled&&t.isAuto||(e.dataCollectionEnabled||t.isAuto)&&F.getInstance().requiredApisAvailable()&&(t.isAuto&&x()!==P.VISIBLE||e.loggingEnabled&&e.logTraceAfterSampling&&(ct()?Ct(t):st().then((function(){return Ct(t)}),(function(){return Ct(t)}))))}function Ct(t){U()&&setTimeout((function(){return Mt(t,1)}),0)}function Ft(t){var e=O.getInstance();if(e.instrumentationEnabled){var n=t.url,r=e.logEndPointUrl.split("?")[0],i=e.flTransportEndpointUrl.split("?")[0];n!==r&&n!==i&&e.loggingEnabled&&e.logNetworkAfterSampling&&setTimeout((function(){return Mt(t,0)}),0)}}function kt(t,e){return 0===e?Nt(t):Lt(t)}function Nt(t){var e={url:t.url,http_method:t.httpMethod||0,http_response_code:200,response_payload_bytes:t.responsePayloadBytes,client_start_time_us:t.startTimeUs,time_to_response_initiated_us:t.timeToResponseInitiatedUs,time_to_response_completed_us:t.timeToResponseCompletedUs},n={application_info:Pt(),network_request_metric:e};return JSON.stringify(n)}function Lt(t){var e={name:t.name,is_auto:t.isAuto,client_start_time_us:t.startTimeUs,duration_us:t.durationUs};0!==Object.keys(t.counters).length&&(e.counters=t.counters);var n=t.getAttributes();0!==Object.keys(n).length&&(e.custom_attributes=n);var r={application_info:Pt(),trace_metric:e};return JSON.stringify(r)}function Pt(){return{google_app_id:O.getInstance().getAppId(),app_instance_id:U(),web_app_info:{sdk_version:m,page_url:F.getInstance().getUrl(),service_worker_status:V(),visibility_state:x(),effective_connection_type:z()},application_process_state:0}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Kt=5e3;function qt(){U()&&(setTimeout((function(){return xt()}),0),setTimeout((function(){return Vt()}),0),setTimeout((function(){return zt()}),0))}function Vt(){for(var t=F.getInstance(),e=t.getEntriesByType("resource"),n=0,r=e;n<r.length;n++){var i=r[n];Bt(i)}t.setupObserver("resource",Bt)}function xt(){var t=F.getInstance(),e=t.getEntriesByType("navigation"),n=t.getEntriesByType("paint");if(t.onFirstInputDelay){var r=setTimeout((function(){Dt.createOobTrace(e,n),r=void 0}),Kt);t.onFirstInputDelay((function(t){r&&(clearTimeout(r),Dt.createOobTrace(e,n,t))}))}else Dt.createOobTrace(e,n)}function zt(){for(var t=F.getInstance(),e=t.getEntriesByType("measure"),n=0,r=e;n<r.length;n++){var i=r[n];$t(i)}t.setupObserver("measure",$t)}function $t(t){var e=t.name;e.substring(0,_.length)!==_&&Dt.createUserTimingTrace(e)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
...
//# sourceMappingURL=page-afterauth~page-googlelogin~page-instagram-blast~page-instagram-index~page-lembur_generate~page-~da02304d.54bb5e8d.js.map